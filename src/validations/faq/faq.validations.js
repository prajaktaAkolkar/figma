...
export default function faqValidation() {
    return [
      ...
      body('title').notEmpty().withMessage("Title required").isString().withMessage("Title must be a string").isLength({min: 3 , max : 20}).withMessage("Title must be between 3 to 20 characters"),
